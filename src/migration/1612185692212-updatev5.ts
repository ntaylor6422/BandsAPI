...
export class updatev51612185692212 implements MigrationInterface {
    name = 'updatev51612185692212'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bands" ("id" SERIAL NOT NULL, "bandName" character varying NOT NULL, "dateFormed" TIMESTAMP NOT NULL, CONSTRAINT "PK_9355783ed6ad7f73a4d6fe50ea1" PRIMARY KEY ("id"))`);
